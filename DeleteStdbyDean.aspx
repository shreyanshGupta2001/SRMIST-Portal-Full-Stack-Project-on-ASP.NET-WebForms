<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="DeleteStdbyDean.aspx.cs" Inherits="SRMISTportal.DeleteStdbyDean" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br>
    <div class="DisplayStdbyTea" id="delstdbydean">
        ...
        <div class="row row1">
            ...
            <tr>
                <td>Student ID:</td>
                <td>
                    <asp:TextBox ID="txtStdID" class="textbox" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th colspan="2">
                    <asp:Button ID="btnStDelete" class="btn" runat="server" Text="Delete Record" OnClick="btnStDelete_Click" />
                    <br />
                    <br />
                    <asp:Label ID="lblMsgDel" runat="server" Text=" "></asp:Label>
                </th>
            </tr>
        </table>
            </div>
