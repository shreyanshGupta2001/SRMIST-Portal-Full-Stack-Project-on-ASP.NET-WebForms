<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="LoginTeaWelcome.aspx.cs" Inherits="SRMISTportal.LoginTeaWelcome" %>
    ...
    <div class="LoginTeawelContents">
        ...
        <div class="row row1">
            ...
            <div class="col col2 timetable">
                <img src="TeaTime.png" height="400px" />
            </div>
        </div>
